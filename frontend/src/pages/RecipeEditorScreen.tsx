  ...
  return (
    <>
      <div className="w-full h-dvh flex flex-col bg-background">
        ...
        <div className="flex items-center justify-between p-4 border-b border-border/40 shrink-0 bg-background pt-[max(8px,env(safe-area-inset-top))]">
        ...
        <div className="flex-1 flex flex-col gap-6 overflow-y-auto px-4 pt-4 pb-4 sm:pb-28">
          {/* --- SEKCJA: PODSTAWY --- */}
                ...
                >
                  ...
                  <div className="grid grid-cols-[minmax(0,1fr)_minmax(0,1fr)_auto] gap-2 items-center">
                    <input
                      ...
                      className="w-full min-w-0 bg-background border border-border/50 rounded-lg px-2 py-2.5 text-sm text-center focus:outline-none focus:ring-1 focus:ring-primary/50"
                    />
                    <select
                      value={ing.unit}
                    ...
                    <Button
                      ...
                      className="h-11 w-11 justify-self-end bg-destructive/25 border-2 border-destructive/25 text-destructive hover:text-red-500 hover:bg-red-500/10 shrink-0"
                    >
                      <Trash2 size={18} />
                    </Button>
                  </div>
        ...
        {/* 3. Dolny pasek akcji */}
        <div className="shrink-0 border-t border-border/50 bg-background p-4 pb-[max(16px,env(safe-area-inset-bottom))]">
